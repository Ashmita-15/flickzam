  ...
  return (
    <main
      style={{
        ...
        background: 'linear-gradient(135deg, #003366 0%, #000000 50%, #808080 100%)', // Gradient covers the whole page
        margin: 0, // Remove extra margin
        padding: 0, // Remove extra padding
        animation: 'fadeIn 1.5s ease-in-out', // Fade-in animation effect
    ...
    >
      ...
      <Box
        sx={{
          ...
          pt: 8, // Adjust padding-top based on the height of the header
          display: 'flex',
          flexDirection: 'column',
      ...
      >
        <Container
          ...
          sx={{
            ...
            width: '100%', // Ensure full width
            boxSizing: 'border-box', // Include padding in width calculation
            backgroundColor: 'transparent', // Ensure container is transparent to show the gradient
          }}
        >
          <Typography
            variant="h3"
          ...
          <Grid container spacing={4} justifyContent="center">
            {['Find by Description', 'Find by Dialogue', 'Find by Image'].map((title, index) => (
              <Grid item xs={12} md={4} key={index} sx={{ px: 1 }}>
                ...
                >
                  ...
                  <Typography variant="body1">
                    {index === 0 &&
                      "Enter a detailed description or plot summary of the movie you're looking for. Our AI will match your input with a vast database to deliver the most relevant movie suggestions. Ideal for finding movies you remember only by their storyline."}
                    {index === 1 &&
                      "Input specific dialogue or quotes from the movie, and FlickZam's AI will identify the film based on your provided text. This feature helps you locate movies based on memorable lines or conversations."}
                    {index === 2 &&
                      "Upload an image, such as a scene or a movie poster, and our AI will recognize the movie based on visual elements. Perfect for identifying films from scenes or promotional images you have."}
                  </Typography>
                </Paper>
              </Grid>
            ))}
          ...
          <Box
            ...
            sx={{
              mb: 8,
              mt: 8,
              py: 8, // Add padding to ensure spacing and background color coverage
              width: '100%', // Ensure full width
              backgroundColor: 'transparent', // Ensure the section is transparent
            }}
          >
            <Typography
              variant="h5"
